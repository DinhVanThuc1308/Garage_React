...
function GarageManagerDetails() {
    ...
    let { id } = useParams();
    useEffect(() => {
        axiosInstance.get(`garages/${id}`)
            .then(res => {
                // Tiếp tục xử lý dữ liệu nếu cần thiết
                const { name, email, phoneNumber, address, openTime, closeTime, owner, status } = res.data.attributes;
                const data = {
                    name,
                    email,
                    phoneNumber,
        ...
        <div>
            <div style={{ width: '100%', backgroundColor: '#f8f5f5', padding: '10px' }}>
                <h3 style={{ fontFamily: 'Poppins', fontSize: 20 }}>
                    <span style={{ fontFamily: 'Poppins', fontSize: "23", color: '#cacaca' }}>Garage &gt;</span> {garage.name}
                </h3>
            </div>
                ...
                <div className="container-infomation-garage-details">
                    <div className="container-infomation-up-garage-details">
                        ...
                        <div className="container-infomation-up-1-garage-details">
                            ...
                            <div className="letter">Open Time:
                                <div className="container-infomation-up-1-1-garage-details no-bold">
                                    <div className="letter1">{garage.openTime}</div>
                                </div>
                            </div>
                            <div className="letter">Close Time:
                                <div className="container-infomation-up-1-1-garage-details">
                        ...
                        <div className="container-infomation-up-1-garage-details">
                            <div className="letter">Garage Owner:
                                <div className="container-infomation-up-1-1-garage-details">
                                    <div className="letter1">{garage.name}</div>
                                </div>
                            </div>
                    ...
                    <div className="container-infomation-down-garage-details">
                        <div className="letter" style={{ marginTop: 30 }}>Services</div>
                        <div className="container-infomation-down-1-garage-details">
                            <div className="">
                                <div className="" style={{ color: "#805EDF", fontFamily: 'Popins', fontSize: 20, fontWeight: 500, padding: '10px' }}>Garage ABC</div>
                            </div>
                            <div className="">
                                <div className="" style={{ color: "#805EDF", fontFamily: 'Popins', fontSize: 20, fontWeight: 500, padding: '10px' }}>TLS</div>
                            </div>
                            <div className="">
                                <div className="" style={{ color: "#805EDF", fontFamily: 'Popins', fontSize: 20, fontWeight: 500, padding: '10px' }}>AHC</div>
                            </div>
                            <div className="">
                                <div className="" style={{ color: "#805EDF", fontFamily: 'Popins', fontSize: 20, fontWeight: 500, padding: '10px' }}>CB Garage</div>
                            </div>
                            <div className="">
                                <div className="" style={{ color: "#805EDF", fontFamily: 'Popins', fontSize: 20, fontWeight: 500, padding: '10px' }}>UCQ</div>
                            </div>
                        </div>
                    </div>
                </div>
